...
{
    public class LePartDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal LePartDicMgr() : base(DictionaryName.LePart) { }

        #region singleton

        // 单例对象
        internal volatile static LePartDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// </summary>
        /// <returns></returns>
        public static LePartDicMgr GetInstance()
        {
            return dicMgr;
        }
