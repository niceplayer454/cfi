...
{
    public class EwgMeetingTeamDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal EwgMeetingTeamDicMgr() : base(DictionaryName.EwgMeetingTeam) { }

        #region singleton

        // 单例对象
        internal volatile static EwgMeetingTeamDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static EwgMeetingTeamDicMgr()
        {
            dicMgr = new EwgMeetingTeamDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static EwgMeetingTeamDicMgr GetInstance()
        {
            return dicMgr;
        }
