...
{
    public class EwgFolderDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal EwgFolderDicMgr() : base(DictionaryName.EwgFolder) { }

        #region singleton

        // 单例对象
        internal volatile static EwgFolderDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static EwgFolderDicMgr()
        {
            dicMgr = new EwgFolderDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static EwgFolderDicMgr GetInstance()
        {
            return dicMgr;
        }
