...
{
    public class LeProblemSourceDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal LeProblemSourceDicMgr() : base(DictionaryName.LeProblemSource) { }

        #region singleton

        // 单例对象
        internal volatile static LeProblemSourceDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static LeProblemSourceDicMgr()
        {
            dicMgr = new LeProblemSourceDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static LeProblemSourceDicMgr GetInstance()
        {
            return dicMgr;
        }
