...
{
    public class CloseLoopDepartmentDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal CloseLoopDepartmentDicMgr() : base(DictionaryName.QiCloseLoopDepartment) { }

        #region singleton

        // 单例对象
        internal volatile static CloseLoopDepartmentDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static CloseLoopDepartmentDicMgr()
        {
            dicMgr = new CloseLoopDepartmentDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static CloseLoopDepartmentDicMgr GetInstance()
        {
            return dicMgr;
        }
