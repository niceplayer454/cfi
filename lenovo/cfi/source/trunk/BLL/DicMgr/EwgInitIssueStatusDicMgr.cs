...
{
    public class EwgInitIssueStatusDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal EwgInitIssueStatusDicMgr() : base(DictionaryName.EwgInitIssueStatus) { }

        #region singleton

        // 单例对象
        internal volatile static EwgInitIssueStatusDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static EwgInitIssueStatusDicMgr()
        {
            dicMgr = new EwgInitIssueStatusDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static EwgInitIssueStatusDicMgr GetInstance()
        {
            return dicMgr;
        }
