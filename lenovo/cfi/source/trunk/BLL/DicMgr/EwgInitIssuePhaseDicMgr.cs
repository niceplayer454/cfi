...
{
    public class EwgInitIssuePhaseDicMgr : TabularDicMgr
    {
        // 私有构造函数
        internal EwgInitIssuePhaseDicMgr() : base(DictionaryName.EwgInitIssuePhase) { }

        #region singleton

        // 单例对象
        internal volatile static EwgInitIssuePhaseDicMgr dicMgr = null;
        // 锁定辅助对象
        ...
        /// 构造函数，初始化单例对象，并加载数据。
        /// </summary>
        static EwgInitIssuePhaseDicMgr()
        {
            dicMgr = new EwgInitIssuePhaseDicMgr();
            dicMgr.Load();          // 加载数据            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static EwgInitIssuePhaseDicMgr GetInstance()
        {
            return dicMgr;
        }
